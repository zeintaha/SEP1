...
public class MemberList extends Participants
{
   ...
   public ArrayList<Members> findByID(String iD)
   {
      ArrayList<Members> members1 = new ArrayList<Members>();
      for (int i = 0; i < memberList.size(); i++)
      {
         Members mem = memberList.get(i);
         if (mem.getMember().getiD().equals(iD))
         {
            members1.add(mem);
         }
      }
   ...
   public ArrayList<Members> findByPhoneNr(String phoneNr)
   {
      ArrayList<Members> members1 = new ArrayList<Members>();
      for (int i = 0; i < memberList.size(); i++)
      {
         Members mem = memberList.get(i);
         if (mem.getMember().getPhoneNr().equals(phoneNr))
         {
            members1.add(mem);
         }
      }
...
//               .size(); index++)
//         {
//            if (mem.getMember().getPreferences().
//                  .equals(activityName))
//            {
//               members1.add(mem);
//            }
...
//   }
   ...
   public void editMember(String name, String email, String iD, String phoneNr,
         String address)
   {
