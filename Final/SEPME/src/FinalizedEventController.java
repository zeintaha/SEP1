...
public class FinalizedEventController implements Initializable
{
   ...
   public void initializeTable()
   {
      ...
      tblFinalizedEvent.setItems(observableEvents);
      tblFinalizedEvent.setStyle("-fx-alignment: CENTER;");
   }
   ...
   public void showFInalizedEvents()
   {
